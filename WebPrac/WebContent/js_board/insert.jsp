...
<div class="container">
	...
	<button type="button" name="btnWrite" class="btn btn-primary pull-right" style="margin-right:10px;">등록</button>
	<button type="button" name="btnInit" class="btn btn-primary pull-right" style="margin-right:10px;">DB초기화</button>
	</form>
</div>
